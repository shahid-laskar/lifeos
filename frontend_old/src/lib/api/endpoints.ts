...
export const ENDPOINTS = {
  ...
  HABITS_LOG:      `${API_BASE}/habits/prayers/log`, // POST
  HABITS_HISTORY:  `${API_BASE}/habits/prayers/status`, // GET (Corrected from /log)
  ...
  QURAN_BOOKMARK_DELETE: (surah: number, ayah: number) => `${API_BASE}/quran/bookmarks/${surah}/${ayah}`,
