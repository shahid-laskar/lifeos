...
from app.api.v1 import ai, auth, families, governance, prayer, users, habits, quran, dhikr, duas, hadith, learning, planner, tasks, goals, calendar, reviews, productivity, journal, reading, skills, health
